...
mysql ${TESTDBOPTS} -e "INSERT INTO Trees(TreeId, KeyId, TreeType, LeafHasherType, TreeHasherType, AllowsDuplicateLeaves) VALUES(${TREE_ID}, 1, 'LOG', 'SHA256', 'SHA256', false)"
