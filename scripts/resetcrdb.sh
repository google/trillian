...
- CRDB_HOST: The hostname of the CockroachDB server (default: localhost).
- CRDB_PORT: The port the CockroachDB server is listening on (default: 3306).
...
collect_vars() {
  ...
  [[ ${VERBOSE} = 'true' ]] && echo "- Using CRDB Flags: ${FLAGS[@]}"
