...
func (m *MockTrillianMapServer) GetLeaves(arg0 context.Context, arg1 *GetMapLeavesRequest) (*GetMapLeavesResponse, error) {
...
func (m *MockTrillianMapServer) GetLeavesByRevision(arg0 context.Context, arg1 *GetMapLeavesByRevisionRequest) (*GetMapLeavesResponse, error) {
...
func (m *MockTrillianMapServer) GetSignedMapRoot(arg0 context.Context, arg1 *GetSignedMapRootRequest) (*GetSignedMapRootResponse, error) {
...
func (m *MockTrillianMapServer) GetSignedMapRootByRevision(arg0 context.Context, arg1 *GetSignedMapRootByRevisionRequest) (*GetSignedMapRootResponse, error) {
...
func (m *MockTrillianMapServer) InitMap(arg0 context.Context, arg1 *InitMapRequest) (*InitMapResponse, error) {
	ret := m.ctrl.Call(m, "InitMap", arg0, arg1)
	ret0, _ := ret[0].(*InitMapResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTrillianMapServer) SetLeaves(arg0 context.Context, arg1 *SetMapLeavesRequest) (*SetMapLeavesResponse, error) {
