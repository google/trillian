...
// Package main contains the implementation and entry point for the undeletetree
// command.
//
// Example usage:
// $ ./undeletetree --admin_server=host:port --log_id=logid
package main
...
var (
	...
	logID           = flag.Int64("log_id", 0, "Trillian LogID to undelete")
)
