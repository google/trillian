...
func PopulateMapSubtreeNodes(hasher merkle.Hasher) storage.PopulateSubtreeFunc {
	return func(st *storagepb.SubtreeProto) error {
		...
		fullTreeDepth := hasher.Size() * depthQuantum
...
func PopulateLogSubtreeNodes(hasher merkle.Hasher) storage.PopulateSubtreeFunc {
	return func(st *storagepb.SubtreeProto) error {
