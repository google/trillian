...
This doc gives a high-level overview of Trillian and its uses, if you're
looking to help developing Trillian then you'll likely also want to read
the [DEVELOPERS.md](DEVELOPERS.md) doc.
