...
type Factory interface {
	NewElection(ctx context.Context, treeID string) (MasterElection, error)
}
...
func (nf NoopFactory) NewElection(ctx context.Context, treeID string) (MasterElection, error) {
