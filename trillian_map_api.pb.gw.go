...
var (
	filter_TrillianMap_ListLeavesByRevision_0 = &utilities.DoubleArray{Encoding: map[string]int{"map_id": 0, "revision": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)

func request_TrillianMap_ListLeavesByRevision_0(ctx context.Context, marshaler runtime.Marshaler, client TrillianMapClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListLeavesByRevisionRequest
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_TrillianMap_ListLeavesByRevision_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.ListLeavesByRevision(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterTrillianMapHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TrillianMapClient) error {
	...
	mux.Handle("GET", pattern_TrillianMap_ListLeavesByRevision_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_TrillianMap_ListLeavesByRevision_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_TrillianMap_ListLeavesByRevision_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_TrillianMap_ListLeavesByRevision_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"v1beta1", "maps", "map_id", "roots", "revision", "leaves"}, ""))
...
var (
	forward_TrillianMap_ListLeavesByRevision_0 = runtime.ForwardResponseMessage
