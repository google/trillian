...
func TestGetTree(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			desc:        "logTree",
			treeID:      logTree.TreeId,
			opts:        NewGetOpts(Query, true, trillian.TreeType_LOG),
			storageTree: &logTree,
			wantTree:    &logTree,
		},
		{
			...
			opts:        NewGetOpts(Query, true, trillian.TreeType_MAP),
			storageTree: &mapTree,
			wantTree:    &mapTree,
		},
		{
			...
			treeID:      logTree.TreeId,
			opts:        NewGetOpts(Query, true, trillian.TreeType_LOG, trillian.TreeType_MAP),
			storageTree: &logTree,
			wantTree:    &logTree,
		},
		{
		...
		},
		{
			desc:        "wrongType3",
			treeID:      mapTree.TreeId,
			opts:        NewGetOpts(Query, true, trillian.TreeType_LOG, trillian.TreeType_PREORDERED_LOG),
			storageTree: &mapTree,
			wantErr:     true,
			code:        codes.InvalidArgument,
		},
		{
			desc:        "adminLogWrite",
			treeID:      logTree.TreeId,
			opts:        NewGetOpts(Admin, false /* readonly */, trillian.TreeType_LOG),
			storageTree: &logTree,
			wantTree:    &logTree,
		},
		{
			desc:        "adminPreorderedWrite",
			treeID:      testonly.PreorderedLogTree.TreeId,
			opts:        NewGetOpts(Admin, false /* readonly */, trillian.TreeType_PREORDERED_LOG),
			storageTree: testonly.PreorderedLogTree,
			wantTree:    testonly.PreorderedLogTree,
		},
		{
			desc:        "adminFrozenWrite",
			treeID:      logTree.TreeId,
			opts:        NewGetOpts(Admin, false /* readonly */, trillian.TreeType_LOG),
		...
		},
		{
			desc:        "adminMapWrite",
			treeID:      mapTree.TreeId,
			opts:        NewGetOpts(Admin, false /* readonly */, trillian.TreeType_MAP),
			storageTree: &mapTree,
			wantTree:    &mapTree,
		},
		{
			desc:        "queryLogWrite",
			treeID:      logTree.TreeId,
			opts:        NewGetOpts(Query, false /* readonly */, trillian.TreeType_LOG),
			storageTree: &logTree,
			wantTree:    &logTree,
			wantErr:     true,
			code:        codes.PermissionDenied,
		...
		{
			desc:        "queryPreorderedWrite",
			treeID:      testonly.PreorderedLogTree.TreeId,
			opts:        NewGetOpts(Query, false /* readonly */, trillian.TreeType_PREORDERED_LOG),
			storageTree: testonly.PreorderedLogTree,
			wantTree:    testonly.PreorderedLogTree,
			wantErr:     true,
			code:        codes.PermissionDenied,
		...
		},
		{
			desc:        "queryMapWrite",
			treeID:      mapTree.TreeId,
			opts:        NewGetOpts(Query, false /* readonly */, trillian.TreeType_MAP),
			storageTree: &mapTree,
			wantTree:    &mapTree,
			wantErr:     true,
			code:        codes.PermissionDenied,
		...
		{
			desc:        "frozenTreeQuery",
			treeID:      frozenTree.TreeId,
			opts:        NewGetOpts(Query, true /* readonly */, trillian.TreeType_LOG),
			storageTree: &frozenTree,
			wantTree:    &frozenTree,
		},
		{
			desc:        "frozenTreeSequence",
			treeID:      frozenTree.TreeId,
			opts:        NewGetOpts(SequenceLog, false /* readonly */, trillian.TreeType_LOG),
			storageTree: &frozenTree,
			wantTree:    &frozenTree,
			wantErr:     true,
			code:        codes.PermissionDenied,
		...
		{
			desc:        "frozenTreeQueue",
			treeID:      frozenTree.TreeId,
			opts:        NewGetOpts(QueueLog, false /* readonly */, trillian.TreeType_LOG),
			storageTree: &frozenTree,
			wantTree:    &frozenTree,
			wantErr:     true,
			code:        codes.PermissionDenied,
