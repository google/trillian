...
func (*ListTreesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_trillian_admin_api_843dd83bfb24352b, []int{0}
}
...
func (*ListTreesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_trillian_admin_api_843dd83bfb24352b, []int{1}
}
...
func (*GetTreeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_trillian_admin_api_843dd83bfb24352b, []int{2}
}
...
func (*CreateTreeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_trillian_admin_api_843dd83bfb24352b, []int{3}
}
...
func (*UpdateTreeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_trillian_admin_api_843dd83bfb24352b, []int{4}
}
...
func (*DeleteTreeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_trillian_admin_api_843dd83bfb24352b, []int{5}
}
...
func (*UndeleteTreeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_trillian_admin_api_843dd83bfb24352b, []int{6}
}
...
func (c *trillianAdminClient) UndeleteTree(ctx context.Context, in *UndeleteTreeRequest, opts ...grpc.CallOption) (*Tree, error) {
	out := new(Tree)
	err := grpc.Invoke(ctx, "/trillian.TrillianAdmin/UndeleteTree", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() {
	proto.RegisterFile("trillian_admin_api.proto", fileDescriptor_trillian_admin_api_843dd83bfb24352b)
}

var fileDescriptor_trillian_admin_api_843dd83bfb24352b = []byte{
