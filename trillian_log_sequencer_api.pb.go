...
func init() {
	proto.RegisterFile("trillian_log_sequencer_api.proto", fileDescriptor_trillian_log_sequencer_api_e4ffc9a5af1038fc)
}

var fileDescriptor_trillian_log_sequencer_api_e4ffc9a5af1038fc = []byte{
