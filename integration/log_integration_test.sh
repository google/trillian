...
./trillian_log_server --private_key_password=towel --private_key_file=${TESTDATA}/trillian-server-key.pem --port ${PORT} --signer_sleep_between_runs="1s" --sequencer_sleep_between_runs="1s" --batch_size=100 -alsologtostderr &
