...
const (
	...
	// empty branch is resursivily computed from empty leaf nodes.
	// NOT secure in a multi tree environment. For testing only.
	HashStrategy_MAP_HASHER HashStrategy = 2
)
...
var fileDescriptor3 = []byte{
	...
	,
}
