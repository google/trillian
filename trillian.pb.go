...
func (LogRootFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_trillian_ada3e9e41837f71e, []int{0}
}
...
func (MapRootFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_trillian_ada3e9e41837f71e, []int{1}
}
...
func (HashStrategy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_trillian_ada3e9e41837f71e, []int{2}
}
...
func (TreeState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_trillian_ada3e9e41837f71e, []int{3}
}
...
func (TreeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_trillian_ada3e9e41837f71e, []int{4}
}
...
func init() { proto.RegisterFile("trillian.proto", fileDescriptor_trillian_ada3e9e41837f71e) }

var fileDescriptor_trillian_ada3e9e41837f71e = []byte{
