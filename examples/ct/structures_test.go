...
func TestSignV1SCTForCertificate(t *testing.T) {
	...
	assert.Equal(t, expected, got, "mismatched SCT")
}
...
func setupMockKeyManager() crypto.KeyManager {
	...
	mockSigner.On("Sign", mock.MatchedBy(
		func(other io.Reader) bool {
			return true
		}), []byte{0xd1, 0x66, 0x49, 0xc7, 0xbb, 0x48, 0xe7, 0x32, 0xa9, 0x71, 0xc3, 0x1b, 0x26, 0xf6, 0x5c, 0x26, 0x85, 0xd3, 0xc, 0xed, 0x22, 0x48, 0xc4, 0xd4, 0xdb, 0xaa, 0xee, 0x9d, 0x44, 0xf4, 0xc1, 0x6f}, hasher).Return([]byte("signed"), nil)
