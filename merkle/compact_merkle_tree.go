...
func NewCompactMerkleTreeWithState(hasher Hasher, size int64, f GetNodeFunc, expectedRoot []byte) (*CompactMerkleTree, error) {
...
func NewCompactMerkleTree(hasher Hasher) *CompactMerkleTree {
	r := CompactMerkleTree{
		hasher: hasher,
		root:   hasher.HashEmpty(),
		nodes:  make([][]byte, 0),
